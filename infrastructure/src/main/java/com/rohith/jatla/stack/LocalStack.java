package com.rohith.jatla.stack;
...
public class LocalStack extends Stack {
    ...
    private CfnCluster createMskCluster(){
        System.out.println("Subnets: " + vpc.getPrivateSubnets().size());
    ...
    public static void main(final String[] args) {
        ...
        URL classLocation = LocalStack.class.getProtectionDomain()
                .getCodeSource().getLocation();

        File classDir = new File(classLocation.getPath()).getParentFile();
        String cdkOutPath = new File(classDir.getParent(), "cdk.out").getAbsolutePath();


        App app = new App(AppProps.builder().outdir(cdkOutPath).build());
